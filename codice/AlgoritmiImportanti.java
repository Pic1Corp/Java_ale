...
public class AlgoritmiImportanti {
    ...
    /** 
     * inseriche un numero dentro ad un array
     * @param array array dove inserire il numero
     * @param n numemro da inserire
     * @param posizione dove inserire il numero
     */
    ...
    public static void giraArray(int[] array){
        int temp;
